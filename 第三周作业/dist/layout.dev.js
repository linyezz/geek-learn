...
function layout(element) {
  ...
  var items = element.children.filter(function (e) {
  ...
  ['width', 'height'].forEach(function (size) {
    ...
    flexLines.forEach(function (items) {
      ...
      if (flexTotal > 0) {
        ...
        items.forEach(function (item) {
          ...
          itemStyle[mainStart] = _currentMain;
          itemStyle[mainEnd] = _currentMain + mainSign * itemStyle[mainSize];
          _currentMain = itemStyle[mainEnd];
        });
      } else {
        ...
        items.forEach(function (item) {
          var itemStyle = getStyle(item);
          itemStyle[mainStart] = _currentMain2;
          itemStyle[mainEnd] = itemStyle[mainStart] + mainSign * itemStyle[mainSize];
          _currentMain2 = itemStyle[mainEnd] + _step;
        });
      }
    });
  }
  ...
  var lineSize = style[crossSize] / items.length;
  var step;
